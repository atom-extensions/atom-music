...
import AtomMusicSearchView from './atom-music-search-view';
...
class AtomMusicView {
	constructor(serialized) {
		...
		if (serialized) {
			this.isPlaying = serialized.isPlaying;
			this.playList = serialized.playList || [];
			this.playListCopy = serialized.playListCopy || [];
			this.currentTrack = serialized.currentTrack;
			this.shuffle = serialized.shuffle;
		}
			...
			<div className="atom-music">
				<div className="audio-controls-container" ref="container">
					<div className="btn-group btn-group-sm">
						...
						<button className="btn icon icon-playback-rewind" on={{click: this.rewind}} ref="rewindButton"></button>
						<button className="btn icon playback-button icon-playback-play" on={{click: this.togglePlayback}} ref="playbackButton"></button>
						<button className="btn icon icon-playback-fast-forward" on={{click: this.forward}} ref="forwardButton"></button>
