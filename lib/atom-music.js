...
const AtomMusic = {
	...
	activate(state) {
		...
		this.subscriptions.add(atom.commands.add("atom-workspace", {
			...
			"atom-music:show-playlist": () => this.atomMusicView.searchPlayList(),
			"atom-music:forward-15s": () => this.atomMusicView.forward15(),
			"atom-music:backward-15s": () => this.atomMusicView.back15(),
